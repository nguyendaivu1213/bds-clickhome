            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-slate-100">
                {loading ? (
                  ...
                  <tr>
                    <td colSpan={5} className="px-6 py-10 text-center text-slate-400">Chưa có bài viết dự án nào.</td>
                  </tr>
                ) : articles.map((item) => (
                  <tr key={item.id} className="hover:bg-slate-50 transition-colors group">
                    ...
                    <td className="px-4 sm:px-6 py-4 sm:py-5 text-right">
                      <div className="flex justify-end gap-1 sm:gap-2">
                        <Link href={`/project-articles/update/${item.id}`} className="p-1 sm:p-1.5 text-slate-400 hover:text-primary transition-colors bg-white rounded-md shadow-sm border border-slate-200 block">
