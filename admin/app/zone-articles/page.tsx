      ...
      <div className="flex flex-col gap-4 sm:gap-6 bg-white p-4 sm:p-6 rounded-xl border border-slate-200 mb-6 sm:mb-8 shadow-sm">
        <div className="w-full">
          <div className="flex w-full items-stretch rounded-lg h-12 bg-slate-50 border border-slate-100 transition-all focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary overflow-hidden">
            ...
            <input className="flex w-full border-none bg-transparent focus:ring-0 h-full placeholder:text-slate-400 text-slate-700 px-4 text-sm sm:text-base font-normal outline-none" placeholder="Tìm tên bài viết phân khu..." />
          </div>
        </div>
        ...
        <div className="flex overflow-x-auto pb-2 -mx-4 px-4 sm:mx-0 sm:px-0 sm:pb-0 items-center gap-2 scrollbar-hide shrink-0">
          <span className="text-xs font-bold uppercase tracking-wider text-slate-400 mr-2 shrink-0">Phân khu:</span>
          <div className="flex h-9 items-center justify-center gap-x-2 rounded-full bg-primary text-white px-5 cursor-pointer text-sm font-semibold shrink-0">Tất Cả Phân Khu</div>
          <div className="flex h-9 items-center justify-center gap-x-2 rounded-full bg-slate-50 border border-slate-200 text-slate-600 px-5 cursor-pointer text-sm font-medium hover:bg-primary/5 hover:text-primary transition-all shrink-0">The Beverly</div>
          <div className="flex h-9 items-center justify-center gap-x-2 rounded-full bg-slate-50 border border-slate-200 text-slate-600 px-5 cursor-pointer text-sm font-medium hover:bg-primary/5 hover:text-primary transition-all shrink-0">Miyabe</div>
        </div>
      </div>
          ...
          <div className="min-w-[700px]">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-slate-100">
                {[
                  { title: "Giới thiệu tiện ích nội khu đỉnh cao", cat: "The Beverly", status: "Đã Đăng", bg: "bg-emerald-50 border border-emerald-100", color: "text-emerald-700", dot: "bg-emerald-500", date: "15 Th03, 2026" },
                  { title: "Tiêu chuẩn bàn giao Ruby", cat: "The Beverly", status: "Bản Nháp", bg: "bg-slate-100 border border-slate-200", color: "text-slate-600", dot: "bg-slate-400", date: "10 Th03, 2026" }
                ].map((item, id) => (
